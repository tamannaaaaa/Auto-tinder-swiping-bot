...
FB_EMAIL = "pythondeveloper23072001@gmail.com"
FB_PASSWORD = "python@23"

chrome_driver_path = Service("C:/Users/simra/OneDrive/Documents/chromedriver.exe")
driver = webdriver.Chrome(service=chrome_driver_path)

driver.get("https://tinder.com/")
sleep(2)
login_button = driver.find_element(By.XPATH,
                                   '//*[@id="q2007963397"]/div/div[1]/div/main/div[1]/div/div/div/div/header/div/div[2]/div[2]')
login_button.click()

sleep(2)
fb_login = driver.find_element(By.XPATH, '//*[@id="q279582321"]/div/div/div[1]/div/div/div[3]/span/div[2]/button')
fb_login.click()
